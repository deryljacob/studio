...
describe('runRevenueLeakCheck Service', () => {
    ...
    it('should NOT create an alert if a corresponding calendar event is found', async () => {
        ...
        const checkinTimestamp = Timestamp.fromDate(new Date(testPayload.bookingDetails.checkinDate!));
        const checkoutTimestamp = Timestamp.fromDate(new Date(testPayload.bookingDetails.checkoutDate!));
