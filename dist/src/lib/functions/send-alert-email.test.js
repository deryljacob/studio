...
const send_alert_email_1 = require("./send-alert-email");
...
describe('Cloud Function: sendAlertEmail', () => {
    ...
    beforeEach(() => {
        ...
        (0, firebase_admin_1.getAdminDb)().collection.mockReturnValue({ doc: docMock });
    });
    afterAll(() => {
        testEnv.cleanup();
    });
    const wrapped = testEnv.wrap(send_alert_email_1.sendAlertEmail);
...
//# sourceMappingURL=send-alert-email.test.js.map